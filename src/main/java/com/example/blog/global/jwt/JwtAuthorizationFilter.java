package com.example.blog.global.jwt;

import com.example.blog.global.exception.RestApiException;
import com.example.blog.global.jwt.JwtUtil;
import com.example.blog.global.security.UserDetailsServiceImpl;
...
public class JwtAuthorizationFilter extends OncePerRequestFilter {
    ...
    private void createErrorResponse(HttpServletResponse res, int status, String message) throws IOException {
        ...
        RestApiException restApiException = new RestApiException(status, message);
